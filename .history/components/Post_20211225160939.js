        ...
        <div className='flex justify-start  px-4  min-h-[132px] h-full mt-5 border-b border-gray  '>
            ...
            <div className=''>
                ...
                <div className='flex justify-around items-center  w-full px-4 h-7  min-h-[32px] mb-2 '>
                    ...
                    <span onClick={likePost}>{liked ? <FavoriteBorderIcon className="cursor-pointer text-red-500 hover:bg-opacity-80 text-base" /> : <FavoriteBorderIcon className="cursor-pointer hover:text-red-500 text-base" />}</span>
