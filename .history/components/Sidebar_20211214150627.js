...
function Sidebar() {
    return (
        <div className=' flex flex-col justify-center items-center xl:items-start xl:w-[340px] p-2 fixed h-full'>
            <ul className='h-full'>
                ...
                <li className='text-white mb-4 p-2 mt-2  hover:opacity-80  hoverAnimation block' >
                    <div className='flex h-7 items-center  xl:justify-start justify-center xl:justify-start'>
                        <span>
                ...
                <li className='hidden text-white mt-10 p-2 hover:opacity-80  hoverAnimation block border-2 rounded-full  border-gray-400'>
