    ...
    return (
        <div className=' flex flex-col justify-center items-center xl:items-start xl:w-[260px] p-2 fixed h-full'>
            <ul className='h-full w-full'>
                ...
                {openLogout && <div className='absolute cursor-pointer hover:bg-opacity-80 flex justify-start items-center bottom-[70px] left-[20px] w-[224px] rounded-full  h-[30px] z-3 bg-gray-800'>
