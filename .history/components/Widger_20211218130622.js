...
function Widger() {
    return (
        <div className='hidden lg:flex flex-col items-center w-[400px]  pl-[68px]' >
            <div className='sticky z-20 h-[50px] flex items-center justify-start  items-center w-full bg-zinc-800 rounded-full '>
            ...
            <div className='absolute top-2 left-2 h-[512px] bg-zinc-800 w-full mt-3 rounded-2xl'>
