    ...
    return (
        <div className=' sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full'>
            <ul>
                ...
                <li className='text-white mt-6 p-2 hover:opacity-80  hoverAnimation block border-2 rounded-full  border-gray-400'>
                    <div className='hidden xl:flex h-7 items-center justify-center xl:justify-start justify-between ' >
