                ...
                <Link href={`/${id}`}>
                    <a >
                        <div className='text-white flex-1 px-4 mb-2 '>
                            <p className='font-bold text-lg'>{post?.username}<span className='px-1 font-light text-sm'>@{post?.tag}</span><span className='px-1 font-light text-sm'><Moment >{post?.timestamp?.toDate()}</Moment></span></p>
                            <p>{post?.text}</p>
                        </div>
