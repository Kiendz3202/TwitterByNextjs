...
function Widger() {
    return (
        <div className='hidden lg:flex flex-col items-center sticky w-[400px]  pl-[68px]' >
            <div className=' z-20 h-[50px] flex items-center justify-start  items-center w-full bg-zinc-800 rounded-full '>
