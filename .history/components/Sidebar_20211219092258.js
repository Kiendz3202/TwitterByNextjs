        ...
        <div className=' flex flex-col justify-center items-center xl:items-start xl:w-[260px] p-2 fixed h-full'>
            <ul className='h-full w-full'>
                ...
                <li className='hidden xl:block text-white mt-10 p-2 hover:opacity-80  hoverAnimation border-2 rounded-full  border-gray-400'>
                    <div className='relative xl:flex h-7 items-center justify-center xl:justify-between  ' >
                        ...
                        <MoreHorizIcon />
                        <div className='absolute flex justify-start items-center ml-4 bottom-10 left-0 w-[224px] rounded-full  h-[30px] z-3 bg-yellow-300'>
                            <LogoutIcon />
                            <p>Logout</p>
                        </div>
                    </div>
