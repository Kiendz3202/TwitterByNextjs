        ...
        <div className='w-full'>
            <div className='flex justify-start w-full px-4 h-7 bg-gray-500 min-h-[132px]'>
                ...
                <div className='text-white flex-1 px-4 '>
                    ...
                    <p>main text</p>
                    {/* <img className='h-[90px] w-[30px] ' src='https://scontent.fhan5-4.fna.fbcdn.net/v/t1.6435-9/120232674_713344279394520_7558732814290978650_n.jpg?_nc_cat=104&ccb=1-5&_nc_sid=174925&_nc_ohc=r2IJDnyrv7YAX9D_68k&_nc_ht=scontent.fhan5-4.fna&oh=00_AT8yh6CPPCI7KrEBk2y0yl3JjxCAOVnVqQPmxxxJS9d9_w&oe=61E188B2' alt='' /> */}
                    <div className='w-[100px] h-[500px] bg-pink-400'></div>
                </div>
