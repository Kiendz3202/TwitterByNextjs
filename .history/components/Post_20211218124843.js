...
function Post() {
    return (
        <div className='flex justify-start  px-4 h-7  min-h-[132px]  '>
            <div>
                <Avatar src='' alt='' />
            </div>
            <div className=''>
                ...
                <img className='w-full rounded-lg mb-3' src='https://phongnhaexplorer.com/wp-content/uploads/con-cat-quang-phu-1-1.jpg' alt='' />

                <div className='flex justify-around items-center  w-full px-4 h-7  min-h-[32px] '>
                    <ChatBubbleOutlineIcon className='cursor-pointer hover:text-blue-500 text-sm' />
                    <AutorenewRoundedIcon className='cursor-pointer hover:text-blue-500 text-sm' />
                    <FavoriteBorderIcon className='cursor-pointer hover:text-blue-500 text-sm' />
                    <IosShareIcon className='cursor-pointer hover:text-blue-500 text-sm' />
                </div>
            </div>
