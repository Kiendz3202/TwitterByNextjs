                    ...
                    <div className='ml-4 flex-1'>
                        ...
                        <div className='flex justify-between'>
                            <div className='text-white flex gap-x-2'>
                                ...
                                <span className='cursor-pointer hover:bg-opacity-80 relative' onClick={chooseIconHandler}>
                                    <InsertEmoticonIcon />
                                    <span id='inputEmoji' className={isEmoji ? '' : 'hidden'} >
                                        <Picker style={{ position: 'absolute', top: '50px', right: '50px' }} />
                                    </span>
                                </span>
