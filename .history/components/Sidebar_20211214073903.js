    ...
    return (
        <div className=' sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full'>
            <ul>
                ...
                <li className='text-white mb-8 mt-2  '>
                    <div className=' '>
                        <button className='h-8 w-8 text-sm xl:inline  bg-[#1d9bf0] text-white rounded-full xl:w-56 xl:h-[52px] xl:text-lg font-bold shadow-md hover:bg-[#1a8cd8]' >Tweet</button>
                    </div>
                </li>
            </ul>
        </div>
