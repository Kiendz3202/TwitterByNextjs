    ...
    return (
        <div className=' sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full'>
            <ul>
                ...
                <li className='text-white mb-8 mt-2  '>
                    <div className='flex h-7 items-center justify-center xl:justify-start bg-[#1d9bf0] rounded-xl '>
                        <button className='pl-4 hidden xl:inline items-center' >Tweet</button>
                    </div>
                </li>
            </ul>
        </div>
