...
function Feed() {
    return (
        <div className='flex-1 max-w-[600px] border-r border-l border-gray-400 ml-[60px] xl:ml-[260px]'>
            ...
            <div>
                <div className='border-b-2 border-gray-500 flex px-4 py-2 w-full overflow-y-scroll ' >
                    <div >
                    ...
                    <div className='ml-4 flex-1'>
                        <textarea className='w-full bg-transparent outline-0 min-h-[50px] row-2   ' placeholder="What's happening?" />
                        <div>
