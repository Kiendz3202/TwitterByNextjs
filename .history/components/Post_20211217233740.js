    ...
    return (
        <div className='w-full'>
            ...
            <div>
                ...
                <img className='bg-transparent' src='https://e7.pngegg.com/pngimages/337/510/png-clipart-computer-icons-like-button-symbol-font-awesome-share-icon-symbol-miscellaneous-angle-thumbnail.png' />
                <FavoriteBorderIcon />
                <IosShareIcon />
            </div>
        </div>
