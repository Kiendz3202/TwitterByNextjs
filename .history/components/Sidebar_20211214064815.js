...
// hidden sm:flex flex-col items-center xl:items-start xl:ư-[340px] p-2 fixed h-full
function Sidebar() {
    return (
        <div className='hidden sm:flex flex-col items-center xl:items-start xl:ư-[340px] p-2 fixed h-full'>
            <ul>
